...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(166)(global || window || undefined);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				dispatch((0, _action.asyncAction)());
			}
		}, {
			key: "render",
	...
	function selectTodos(todos, filter) {
		switch (filter) {
			case _action.VISIBILITY.SHOW_ALL:
				return todos;
			case _action.VISIBILITY.SHOW_COMPLETED:
				return todos.filter(function (todo) {
					return todo.completed;
				});
			case _action.VISIBILITY.SHOW_ACTIVE:
				return todos.filter(function (todo) {
					return !todo.completed;
				});
		}
	    ...
	    _createClass(Addtodo, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                null,
	                _react2.default.createElement("input", { type: "text", className: "input", placeholder: "添加任务", ref: "input", onKeyDown: this.handleKeyDown.bind(this) })
	            );
	        }
	    }]);
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.props.todos.map(function (todo, index) {
						return _react2.default.createElement(_todo2.default, _extends({}, todo, { onClick: function onClick() {
	...
	var Todo = function (_React$Component) {
		...
		_createClass(Todo, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"li",
					{ onClick: this.props.onClick, style: { textDecoration: this.props.completed ? "line-through" : "none", cursor: this.props.completed ? "default" : "pointer" } },
					this.props.text
				);
			}
		}]);
				...
				if (filter == this.props.filter) {
					...
					return _react2.default.createElement(
						...
						{ href: "#", onClick: function onClick() {
								return _this2.props.onFilterChange(filter);
							} },
						name
					);
				}
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"span",
						null,
						this.renderFilter("SHOW_ACTIVE", "执行中")
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SHOW_ALL = _action.VISIBILITY.SHOW_ALL;
	...
	var todoApp = (0, _redux.combineReducers)({ visibilityFilter: visibilityFilter, todos: todos });
